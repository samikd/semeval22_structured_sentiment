...
if __name__ == "__main__":
    ...
    parser.add_argument("--datasets", default=["darmstadt_unis"])
    ...
    for dataset in args.datasets:
        for data_split in os.listdir(os.path.join("../data", dataset)):
            if data_split in ["train.json", "dev.json", "test.json"]:
                ...
                os.makedirs(os.path.join("semeval_bio_data", "extraction", dataset), exist_ok=True)
                with open(os.path.join("semeval_bio_data", "extraction", dataset, data_split), "w") as outfile:
                    #outfile.write('[')
                    for example in bio_split:
                        ...
                        outfile.write("\n")
                    #outfile.write(']')
    print('All files are saved in semeval_bio_data folder')
